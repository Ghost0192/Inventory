...
export default function UsuariosPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            // 🟢 Verificar si ya existe en a_usuarios
            ...
            // 1️⃣ Crear usuario en Auth (esto disparará el trigger en la BD)
            ...
            // ⚠️ El trigger ya insertó el usuario en a_usuarios automáticamente
